...
/*
 * MapDashboard.h is not duplicated in the source bundle. Keep the new event ID
 * in this shared header so MapDashboard.c and RetroSpectrum.c agree without
 * changing the existing dashboard event enum.
 */
#ifndef RETROSPECTRUM_DASHBOARD_EVENT_CORRELATION
#define RETROSPECTRUM_DASHBOARD_EVENT_CORRELATION 7007
#endif
